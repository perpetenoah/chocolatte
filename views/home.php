                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 col-12 mx-auto">
                                <em class="small-text"><?= $supTitle; ?></em>
                ...
                <section class="barista-section section-padding section-bg" id="barista-team">
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <?php foreach ($employees as $index => $employees): ?>
                            <div class="col-lg-3 col-md-6 col-12 mb-4">
                                <div class="team-block-wrap">
                                    <div class="team-block-info d-flex flex-column">
                                        <div class="d-flex mt-auto mb-3">
                                            <h4 class="text-white mb-0"><?=$employees->name; ?></h4>

                                            <p class="badge ms-4"><em><?=$employees->job; ?></em></p>
                                        </div>

                                        <p class="text-white mb-0"><?=$employees->description; ?> </p>
                                    </div>

                                    <div class="team-block-image-wrap">
                                        <img src="<?=$employees->img ?>" class="team-block-image img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
